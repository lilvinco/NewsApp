...
import static com.example.android.newnewsapp.NewsActivity.LOG_TAG;
    ...
    private static List<News> extractFeatureFromJson(String newsJSON) {
        ...
        try {
            ...
            for (int i = 0; i < newsArray.length(); i++) {
                ...
                // Get a single news at position i within the list of newsItems
                ...
                News news = new News(category, headline, currentTime, url);

                // Add the new {@link News} to the list of newsItems.
                newsItems.add(news);
            }
